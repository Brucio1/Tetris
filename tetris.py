...
def plot_on_board(background, tetraminoe, locked):
...
def print_score(screen):
	...
	textsurface = font.render('Lines cleared: ', False, (255,255,255))
	screen.blit(textsurface,(width/5,height/2))
...
def main():
	...
	while(is_using_program):
		...
		plot_on_board(screen, tetraminoe, locked)
